...
import { BarChart2, ChevronRight, ClipboardList, Columns3, HeartPulse, History, Play, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <Link href="/fitness/cardio" className="block">
          <Card className="panel-hover press-flash flex h-full flex-col gap-4 p-4">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-card-2">
              <HeartPulse className="h-5 w-5 text-muted" />
            </span>
            <span className="block">
              <span className="flex items-center gap-1 font-semibold">
                Log cardio
